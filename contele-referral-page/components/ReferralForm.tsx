  ...
  return (
    <div className="bg-white p-5 md:p-8 rounded-2xl shadow-2xl border-t-4 border-contele-accent relative overflow-hidden">
      <div className="absolute top-3 right-3 md:top-4 md:right-4 opacity-40 pointer-events-none">
        <svg className="w-16 h-16 md:w-24 md:h-24" viewBox="0 0 512 512" fill="none" aria-hidden="true">
          <path d="M112.57 391.19c20.056 0 38.928-7.808 53.12-22l76.693-76.692c5.385-5.404 14.765-5.384 20.15 0l76.886 76.886c14.192 14.192 33.064 22 53.12 22h8.899l-97.09-97.09c-20.702-20.702-54.327-20.702-75.029 0l-97.086 97.086h.337z" fill="#32BCAD"/>
          <path d="M112.233 120.96h-.337l97.086 97.086c20.702 20.702 54.327 20.702 75.03 0l97.089-97.087h-8.899c-20.056 0-38.928 7.808-53.12 22l-76.886 76.886c-5.576 5.576-14.574 5.576-20.15 0L145.353 142.96c-14.192-14.192-33.064-22-53.12-22z" fill="#32BCAD"/>
          <path d="M420.361 255.983l53.296-53.296c14.192-14.192 14.192-37.201 0-51.393l-53.455-53.454c-6.124 0-12.248 2.333-16.912 6.997l-59.107 59.107c-5.577 5.577-5.577 14.573 0 20.15l76.178 71.889zm0 0l-76.018 72.049c-5.576 5.576-5.576 14.573 0 20.15l59.107 59.107c4.664 4.664 10.788 6.997 16.912 6.997l53.455-53.455c14.192-14.192 14.192-37.2 0-51.393l-53.456-53.455z" fill="#32BCAD"/>
          <path d="M91.639 255.983L38.343 309.44c-14.192 14.192-14.192 37.2 0 51.392l53.455 53.455c6.124 0 12.249-2.333 16.913-6.997l59.107-59.107c5.576-5.577 5.576-14.574 0-20.15l-76.179-71.89v-.16zm0 0l76.018-72.049c5.577-5.577 5.577-14.574 0-20.15l-59.107-59.108c-4.664-4.664-10.789-6.997-16.913-6.997L38.182 151.134c-14.192 14.192-14.192 37.2 0 51.393l53.457 53.456z" fill="#32BCAD"/>
        </svg>
      </div>
