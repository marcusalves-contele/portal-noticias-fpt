...
const App = () => {
  return (
    <div className="min-h-screen bg-contele-blue relative overflow-x-hidden font-sans selection:bg-contele-accent selection:text-white">
      ...
      <main className="container mx-auto px-4 md:px-6 pt-20 pb-16 lg:py-0 min-h-screen flex items-center relative z-10">
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-20 items-center">

          {/* Left Column: Benefits & Value Prop - Always first (mobile + desktop) */}
          <div>
            <Benefits />
          </div>

          {/* Right Column: Form - Always second (after user sees value) */}
      ...
      <footer className="absolute bottom-4 w-full text-center text-xs z-10 px-4">
        <div className="flex flex-col md:flex-row items-center justify-center gap-1 md:gap-3">
          <a
            href="https://contele.io/whatsapp"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 text-blue-200/50 hover:text-blue-100 transition-colors"
          >
          ...
          <span className="text-blue-200/40">&copy; {new Date().getFullYear()} Contele. Todos os direitos reservados.</span>
        </div>
      </footer>
    </div>
  );
